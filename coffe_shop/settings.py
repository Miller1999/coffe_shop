...
# Se instala DJANGO-ENVIRON para usar variables de entorno, se crea el .env y se usa asi:
env = environ.Env()
...
SECRET_KEY = "django-insecure-#70wxc_0@xb^px45a=!so$1(l)s&7v6ncadu)#9brg*7^cc7vd"
...
#! Se deben registrar TODAS las apps que creemos
INSTALLED_APPS = [
...
TEMPLATES = [
    {
        #   En dirs se colocan de donde queremos que importe los templates
